namespace DuckGame.DairoshiMod
{
    ...
    public class Shuriken : Gun
    {
        ...
        public Shuriken(float xval, float yval) : base(xval, yval)
        {
            sprite = new Sprite(GetPath("shuriken"));
            graphic = sprite;
            _center = new Vec2(7.5f, 7.5f);
            _collisionSize = new Vec2(15f, 15f);
            _collisionOffset = new Vec2(-7.5f, -7.5f);
